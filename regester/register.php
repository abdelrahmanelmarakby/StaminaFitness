...
<body>
	...
	<div class="sub-main-w3">
		<form action="process.php" method="post">
			...
			<div class="form-style-agile">
				...
				<br>
				<input style="width: 100%; height: 40px; font-size: 17px;padding-left:10px; " placeholder="E-Mail" name="mail" type="email" required="">
			</div>
			<div class="form-style-agile">
				<label>
					Gender
				...
				<br>
				<select style="width: 100%; height: 40px; font-size:17px; padding-left:10px;" name="Gender" type="text" required="">
	...
	<!-- copyright -->
	<div class="footer">
		<h2>&copy; 2020 Fitness Login Form. All rights reserved | Designed by 
			<a href="">Abdelrahman Elmarakby</a>
		</h2>
	</div>
	<!-- //copyright -->
